...
void InitTFTFont() {
    ...
    switch (tftlocaleid) {
        ...
        case LID_CP1251: //俄语
        {
            gfont = CreateLogFont("ttf", "arab", "UTF-8", FONT_WEIGHT_REGULAR, FONT_SLANT_ROMAN, FONT_FLIP_NIL,
                                  FONT_OTHER_NIL, FONT_UNDERLINE_NONE, FONT_STRUCKOUT_NONE, 14, 0);
            gfont1 = CreateLogFont("ttf", "arab", "UTF-8", FONT_WEIGHT_REGULAR, FONT_SLANT_ROMAN, FONT_FLIP_NIL,
                                   FONT_OTHER_NIL, FONT_UNDERLINE_NONE, FONT_STRUCKOUT_NONE, 12, 0);
            lvfont = CreateLogFont("ttf", "arab", "UTF-8", FONT_WEIGHT_REGULAR, FONT_SLANT_ROMAN, FONT_FLIP_NIL,
                                   FONT_OTHER_NIL, FONT_UNDERLINE_NONE, FONT_STRUCKOUT_NONE, 12, 0);
            tftmulfont = gfont;
            break;
        }
        case LID_CP1254: //土尔其
        {
            gfont = CreateLogFont("ttf", "Verdana", "UTF-8", FONT_WEIGHT_REGULAR, FONT_SLANT_ROMAN, FONT_FLIP_NIL,
                                  FONT_OTHER_NIL, FONT_UNDERLINE_NONE, FONT_STRUCKOUT_NONE, 12, 0);
            gfont1 = CreateLogFont("ttf", "Verdana", "UTF-8", FONT_WEIGHT_REGULAR, FONT_SLANT_ROMAN, FONT_FLIP_NIL,
                                   FONT_OTHER_NIL, FONT_UNDERLINE_NONE, FONT_STRUCKOUT_NONE, 10, 0);
            lvfont = CreateLogFont("ttf", "Verdana", "UTF-8", FONT_WEIGHT_REGULAR, FONT_SLANT_ROMAN, FONT_FLIP_NIL,
                                   FONT_OTHER_NIL, FONT_UNDERLINE_NONE, FONT_STRUCKOUT_NONE, 10, 0);
            tftmulfont = gfont;
            break;
        }
        case LID_BIG5: {
            ...
            gfont = CreateLogFont("ttf", "mingliu", "UTF-8", FONT_WEIGHT_REGULAR, FONT_SLANT_ROMAN, FONT_FLIP_NIL,
                                  FONT_OTHER_NIL, FONT_UNDERLINE_NONE, FONT_STRUCKOUT_NONE, 15, 0);
            gfont1 = CreateLogFont("ttf", "mingliu", "UTF-8", FONT_WEIGHT_REGULAR, FONT_SLANT_ROMAN, FONT_FLIP_NIL,
                                   FONT_OTHER_NIL, FONT_UNDERLINE_NONE, FONT_STRUCKOUT_NONE, 13, 0);
            lvfont = CreateLogFont("ttf", "mingliu", "UTF-8", FONT_WEIGHT_REGULAR, FONT_SLANT_ROMAN, FONT_FLIP_NIL,
                                   FONT_OTHER_NIL, FONT_UNDERLINE_NONE, FONT_STRUCKOUT_NONE, 13, 0);
            tftmulfont = gfont;
        ...
        case LID_UTF8: {
            gfont = CreateLogFont("ttf", "arab", "UTF-8", FONT_WEIGHT_REGULAR, FONT_SLANT_ROMAN, FONT_FLIP_NIL,
                                  FONT_OTHER_NIL, FONT_UNDERLINE_NONE, FONT_STRUCKOUT_NONE, 14, 0);
            gfont1 = CreateLogFont("ttf", "arab", "UTF-8", FONT_WEIGHT_REGULAR, FONT_SLANT_ROMAN, FONT_FLIP_NIL,
                                   FONT_OTHER_NIL, FONT_UNDERLINE_NONE, FONT_STRUCKOUT_NONE, 11, 0);
            lvfont = CreateLogFont("ttf", "arab", "UTF-8", FONT_WEIGHT_REGULAR, FONT_SLANT_ROMAN, FONT_FLIP_NIL,
                                   FONT_OTHER_NIL, FONT_UNDERLINE_NONE, FONT_STRUCKOUT_NONE, 11, 0);
            tftmulfont = gfont;
            break;
        ...
        case LID_CP874: //泰文
        {
            gfont = CreateLogFont("ttf", "thai", "UTF-8", FONT_WEIGHT_REGULAR, FONT_SLANT_ROMAN, FONT_FLIP_NIL,
                                  FONT_OTHER_NIL, FONT_UNDERLINE_NONE, FONT_STRUCKOUT_NONE, 12, 0);
            gfont1 = CreateLogFont("ttf", "thai", "UTF-8", FONT_WEIGHT_REGULAR, FONT_SLANT_ROMAN, FONT_FLIP_NIL,
                                   FONT_OTHER_NIL, FONT_UNDERLINE_NONE, FONT_STRUCKOUT_NONE, 10, 0);
            lvfont = CreateLogFont("ttf", "thai", "UTF-8", FONT_WEIGHT_REGULAR, FONT_SLANT_ROMAN, FONT_FLIP_NIL,
                                   FONT_OTHER_NIL, FONT_UNDERLINE_NONE, FONT_STRUCKOUT_NONE, 10, 0);
            tftmulfont = gfont;
            break;
        }
        case LID_SJIS: //日文
        {
            gfont = CreateLogFont("ttf", "japan", "UTF-8", FONT_WEIGHT_REGULAR, FONT_SLANT_ROMAN, FONT_FLIP_NIL,
                                  FONT_OTHER_NIL, FONT_UNDERLINE_NONE, FONT_STRUCKOUT_NONE, 15, 0);
            gfont1 = CreateLogFont("ttf", "japan", "UTF-8", FONT_WEIGHT_REGULAR, FONT_SLANT_ROMAN, FONT_FLIP_NIL,
                                   FONT_OTHER_NIL, FONT_UNDERLINE_NONE, FONT_STRUCKOUT_NONE, 13, 0);
            lvfont = CreateLogFont("ttf", "japan", "UTF-8", FONT_WEIGHT_REGULAR, FONT_SLANT_ROMAN, FONT_FLIP_NIL,
                                   FONT_OTHER_NIL, FONT_UNDERLINE_NONE, FONT_STRUCKOUT_NONE, 13, 0);
            tftmulfont = gfont;
...
char *GetPicPath(char *name) {
    ...
    if (!PicFilePath[0])
        if (!LoadStr("PICFILEPATH", PicFilePath))
            memset(PicFilePath, 0, 80);
...
int InitProc(void) {
    ...
    //初始化字体
    InitTFTFont();
    if ((gOptions.ShowStyle) || (tftlocaleid == LID_CP1256))
    //modify by jazzy 2008.08.02 if arabic language must transfer
    {
    ...
    if ((gOptions.RS232On || gOptions.RS485On) && (
            !gOptions.IsSupportModem || !gOptions.ModemEnable || !(gOptions.ModemModule == 1))) {
    ...
    if ((gOptions.LockFunOn & LOCKFUN_DOORSENSOR) || gOptions.IsACWiegand || gOptions.ExtWGInFunOn || gOptions.
        RFCardFunOn) {
        ExOpenWiegand();
    }
...
char *GetWeekStr(int n) {
    ...
    switch (n) {
        case 1: strcpy(WeekStr, LoadStrByID(HID_DAY1));
            break;
        case 2: strcpy(WeekStr, LoadStrByID(HID_DAY2));
            break;
        case 3: strcpy(WeekStr, LoadStrByID(HID_DAY3));
            break;
        case 4: strcpy(WeekStr, LoadStrByID(HID_DAY4));
            break;
        case 5: strcpy(WeekStr, LoadStrByID(HID_DAY5));
            break;
        case 6: strcpy(WeekStr, LoadStrByID(HID_DAY6));
            break;
        case 0: strcpy(WeekStr, LoadStrByID(HID_DAY0));
            break;
    }
    return WeekStr;
}
...
static void ShowBatteryStatus(HWND hWnd, int TimeFlag) {
    ...
    if (BatteryMod == BATTERY_Internal) {
        ...
        switch (vbat) {
            case 0: FillBoxWithBitmap(hdc, 280, y, 36, 12, &bat0);
                break;
            case 1: FillBoxWithBitmap(hdc, 280, y, 36, 12, &bat1);
                break;
            case 2: FillBoxWithBitmap(hdc, 280, y, 36, 12, &bat2);
                break;
            case 3: FillBoxWithBitmap(hdc, 280, y, 36, 12, &bat3);
                break;
            case 4: FillBoxWithBitmap(hdc, 280, y, 36, 12, &bat4);
                break;
            default: {
...
static int ShowTimeBox(HWND hWnd) {
    ...
    mem_dc = CreateMemDC(gOptions.LCDWidth, gOptions.LCDHeight - 30, 16, MEMDC_FLAG_HWSURFACE | MEMDC_FLAG_SRCALPHA,
...
static int processstarbar(HWND hWnd) {
    ...
    if (gOptions.ShowState) {
        if ((gOptions.AlwaysShowState) && (gDesktop.flage & STATE_ENABLELOGO) && (!workingbool))
            procmainstatekey(hWnd, -1);
        if (gfont == NULL)
            statefont = CreateLogFont(NULL, "fixed", "GB2312", FONT_WEIGHT_REGULAR, FONT_SLANT_ROMAN,
    ...
    for (i = 0; i < 8; i++) {
        ...
        if (FDB_GetShortKey(i + 1, &mystkey) != NULL) {
            ...
            if (mystkey.keyFun == 1) //moify by jazzy for menu error 2008.08.14
            {
                ...
                //	temp[19]=0x0;
                if ((num % 2) && (strlen((char *) mystkey.stateName) == STATE_NAME_LEN) && temp[STATE_NAME_LEN - 1] >=
                    0xa0)
        ...
        if (t.tm_min != gBellTime.tm_min) {
            ...
            if (gOptions.UseNewBell) {
                ...
                for (i = 1; i < gOptions.AlarmMaxCount + 1; i++) {
                    if (FDB_GetAlarm(i, &taa) && taa.AlarmHour == t.tm_hour && taa.AlarmMin == t.tm_min && taa.
                        AlarmStatus) {
                        HaveValidBell = 1;
...
static int display_public_sms(HWND hWnd) {
    if (bsmscount && gOptions.IsSupportSMS && !asmsflag && !vfwndflag && !menuflag && !workingbool && !gDesktop.
        waitsec) {
        ...
        //处理快捷键<liming>
            ...
            if (wParam == SCANCODE_MENU) {
                if (!show_attlog_by_menu(hWnd)) {
                    ...
                    WaitAdminRemainCnt = FDB_CntAdminUser();
                    if (WaitAdminRemainCnt == 0 || (
                            (gAlarmStrip > ALARMSTRIPTAG + 30) && (gAlarmStrip < ALARMSTRIPTAG + 60))) {
                        gLocalCorrectionImage = FALSE;
                        ShowMainMenu(hWnd);
